...
class Course implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['stream_code'] = isset($data['stream_code']) ? $data['stream_code'] : null;
    ...
    {
        return $this->container['stream_code'];
    }

    /**
     * Sets stream_code
     *
     * @param string|null $stream_code Content Package Identifier.
     *
     * @return $this
     */
    public function setStreamCode($stream_code)
    {
        $this->container['stream_code'] = $stream_code;
